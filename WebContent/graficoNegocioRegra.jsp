   ...
   var mmmaior = [];
    ...
    var coots = cots.split('#');
   	...
   	for (i=0; i<coots.length; i++){
   		...
   		mmmenor.push([params[0], params[2]]);
   		mmmaior.push([params[0], params[3]]);
   	}
...
<f:view>
	...
	<br>
	<h:commandButton value="VALE" action="#{flotHandler.doVale}"/>
	<rich:spacer width="20"/>
	<h:commandButton value="PETRO" action="#{flotHandler.doPetro}"/>
